...
const AboutPage = props => {
  const { portfolio_about, portfolio_drawing } = useImageQuery();
      ...
      >
        ...
        >
          <p>
            ...
            <a href="https://www.bgsu.edu/graduate/graduate-programs/data-science.html" target="_blank">
              <span
                sx={{
                  color: 'woodSmoke',
                  textDecoration: 'none',
            ...
            at the
            <a href="https://www.bgsu.edu/" target="_blank">
              <span
                sx={{
                  color: 'woodSmoke',
                  textDecoration: 'none',
